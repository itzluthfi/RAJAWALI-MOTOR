...
<div class="min-h-screen grid grid-cols-1 lg:grid-cols-12 relative overflow-hidden">
    ...
    <div class="hidden lg:flex lg:col-span-7 login-hero-bg relative p-12 flex-col justify-between overflow-hidden">
        ...
        <div class="relative z-10 flex items-center gap-3">
            <div class="w-11 h-11 rounded-2xl bg-white p-1.5 shadow-lg border border-white/40 shrink-0 flex items-center justify-center overflow-hidden">
        ...
        <div class="w-full max-w-md space-y-8 relative">
            ...
            <div class="text-center space-y-3">
                <a href="{{ route('home') }}" class="inline-block group">
                    <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-3xl bg-white p-2.5 shadow-xl shadow-red-900/10 border border-slate-100 flex items-center justify-center mx-auto overflow-hidden group-hover:scale-105 group-hover:shadow-2xl transition-all duration-300">
                        <img alt="Rajawali Motor Logo" class="w-full h-full object-contain rounded-2xl" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAsYEm9KYYbuD248b0jN_sheEfynwQ6j7teJdvKA8edK8NYF0ndmkXVXlqw9SKIhago4iUYt5RmUV5kgkIuq0AjjoDKToRqxiuEM17EOurrulLi0qsUlk36AxIH4JObdUrym7rxUnRAwC9aLkxP4pUlSgGe9qLiTLXOV0I1-pYXxewRVi_zU2DtKVLzY0W20Ve5lzZD-FdFadE3YvJ_ozDGIJmgDt6aLfSKhBNi1YFqbLL-76iue9ykhTo7OsirOQuyfFH_HfkN0Dc"/>
                    </div>
                </a>
