...
<head>
    ...
    <title>Layanan Ban & Spooring 3D Laser | Rajawali Motor Surabaya</title>
    <meta name="description" content="Layanan spooring laser 3D, balancing digital, rotasi ban, dan perbaikan kaki-kaki mobil di Rajawali Motor Surabaya.">

    <!-- OpenGraph Social Preview Meta Tags -->
    <meta property="og:type" content="website"/>
    <meta property="og:url" content="https://rajawalimotor.com/layanan/ban-spooring"/>
    <meta property="og:title" content="Layanan Ban & Spooring 3D Laser | Rajawali Motor Surabaya"/>
    <meta property="og:description" content="Spooring laser 3D, balancing digital & rotasi 4 roda kendaraan di Surabaya."/>
...
<a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Halo Rajawali Motor, saya ingin booking spooring...') }}" target="_blank" rel="noopener" aria-label="Chat via WhatsApp"
...
<nav class="fixed top-0 w-full z-50 glass-nav shadow-sm border-b border-outline-variant/20">
    <div class="flex justify-between items-center px-4 sm:px-8 py-3.5 max-w-7xl mx-auto">
        ...
        <div class="hidden lg:flex items-center gap-8 font-medium text-sm text-secondary">
            ...
            <a class="text-primary font-bold border-b-2 border-primary pb-0.5" href="{{ route('layanan.ban-spooring') }}">Ban & Spooring</a>
        ...
        <div class="hidden sm:flex items-center gap-3">
            <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Halo Rajawali Motor, saya ingin booking spooring balancing...') }}" target="_blank" rel="noopener"
...
<nav class="fixed inset-y-0 left-0 w-80 max-w-[85vw] rounded-r-2xl bg-surface z-[70] flex flex-col h-full p-6 -translate-x-full transition-transform duration-300 shadow-2xl overflow-y-auto" id="drawer">
    ...
    <div class="flex flex-col gap-2">
        ...
        <a class="flex items-center gap-3.5 p-3.5 bg-primary-container text-white font-semibold rounded-xl shadow-md" href="{{ route('layanan.ban-spooring') }}">
            <span class="material-symbols-outlined text-white">tire_repair</span> Ban & Spooring
        </a>
    ...
    <div class="mt-auto pt-6 border-t border-outline-variant/30 flex flex-col gap-3">
        <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Halo Rajawali Motor, saya ingin booking spooring balancing...') }}" target="_blank" rel="noopener" class="efek-kilau w-full bg-[#25D366] text-white text-center py-3.5 rounded-xl font-bold text-sm shadow-lg flex items-center justify-center gap-2 hover:bg-[#20bd5a] transition-all">
...
<main class="pt-20">
    <section class="relative min-h-[70vh] flex items-center overflow-hidden">
        <div class="absolute inset-0 z-0">
            <div class="w-full h-full bg-cover bg-center" style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuBpO0otRCjbc3xPC489K5Rqf_XwfDph2qNFST_6dsVTTfVnoGVbzyVvxcHfMh9hzdzYXcjicGD8fYQYpKjl8u6ojLdcaxIagqeAhkyxpiYlJCinQUich1LO2l93vye3s8fpniNuxyzsc0csP1z0oNMIsVuOofQOenTt39WLbpRY65zb9MCna8iO-vgTLPCs6gJzKbFbFuAvVnSAmtMDStJNc975INbs-0Otv0mXguRLRtppT5ogcA_r5YReQsI7O8_NItKWsHb95D0')"></div>
        ...
        <div class="relative z-10 px-4 sm:px-8 max-w-7xl mx-auto w-full py-16 sm:py-24 text-white">
            <div class="max-w-3xl space-y-6" data-reveal>
                <span class="inline-flex items-center gap-2 bg-primary-container px-4 py-1.5 rounded-full font-bold text-xs uppercase tracking-widest text-white">
                    <span class="material-symbols-outlined text-sm">tire_repair</span> 3D Laser Alignment & Balancing
                </span>
                <h1 class="text-3xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">Spooring 3D Laser & Wheel Balancing</h1>
                <p class="text-white/80 text-base sm:text-xl max-w-2xl leading-relaxed">Penyelarasan sudut kemudi 4 roda menggunakan komputerisasi kamera 3D laser untuk kenyamanan berkendara yang stabil dan mencegah aus ban tidak merata.</p>
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
                    <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Halo Rajawali Motor, saya ingin booking spooring...') }}" target="_blank" rel="noopener"
    ...
    <section class="py-20 px-4 sm:px-8 bg-surface-container-low">
        <div class="max-w-7xl mx-auto">
            <div class="text-center max-w-2xl mx-auto mb-16" data-reveal>
                <p class="text-primary font-bold text-xs uppercase tracking-widest mb-2">PAKET SPOORING & BALANCING</p>
                <h2 class="font-bold text-2xl sm:text-4xl text-on-surface">Pilih Layanan Kaki-Kaki & Ban</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch" data-reveal-stagger>
                <div data-reveal-item class="kartu-angkat efek-kilau bg-white p-8 rounded-3xl border border-outline-variant/40 shadow-sm flex flex-col justify-between">
                    <div>
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <h3 class="font-bold text-2xl text-on-surface">Balancing Digital</h3>
                                <p class="text-secondary text-xs mt-1">4 Roda Kendaraan</p>
                            </div>
                            <div class="text-right">
                                <p class="text-primary font-bold text-2xl">Rp 100.000</p>
                            </div>
                        </div>
                        <ul class="space-y-3 mb-8 text-sm text-secondary">
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Balancing Digital 4 Roda</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Penyesuaian Timah Timbal Baru</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Cek Tekanan Angin Nitrogen</li>
                        </ul>
                    </div>
                    <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Saya berminat Paket Balancing 4 Roda') }}" target="_blank" rel="noopener"
                ...
                <div data-reveal-item class="kartu-angkat efek-kilau bg-inverse-surface p-8 rounded-3xl ring-4 ring-primary shadow-2xl relative flex flex-col justify-between">
                    ...
                    <div>
                        <div class="flex justify-between items-start mb-6 pt-2">
                            <div>
                                <h3 class="font-bold text-2xl text-white">Spooring 3D Laser</h3>
                                <p class="text-primary-fixed-dim text-xs mt-1">Computerized Alignment</p>
                            </div>
                            <div class="text-right">
                                <p class="text-primary-fixed-dim font-bold text-2xl">Rp 175.000</p>
                            </div>
                        </div>
                        <ul class="space-y-3 mb-8 text-sm text-white/90">
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary-fixed-dim text-base">verified</span> Penyelarasan Angle Camber, Caster, Toe</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary-fixed-dim text-base">verified</span> Sensor Kamera Laser 3D Presisi</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary-fixed-dim text-base">verified</span> Cetak Print Out Laporan Alignment</li>
                        </ul>
                    </div>
                    <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Saya berminat Paket Spooring 3D Laser') }}" target="_blank" rel="noopener"
                ...
                <div data-reveal-item class="kartu-angkat efek-kilau bg-white p-8 rounded-3xl border border-outline-variant/40 shadow-sm flex flex-col justify-between">
                    <div>
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <h3 class="font-bold text-2xl text-on-surface">Komplit Kaki-Kaki</h3>
                                <p class="text-secondary text-xs mt-1">Spooring + Balancing + Rotasi</p>
                            </div>
                            <div class="text-right">
                                <p class="text-primary font-bold text-2xl">Rp 250.000</p>
                            </div>
                        </div>
                        <ul class="space-y-3 mb-8 text-sm text-secondary">
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Spooring 3D Laser Alignment</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Balancing 4 Roda Digital</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Rotasi Silang Posisi Ban</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Inspeksi Tie Rod, Ball Joint, Shock Absorber</li>
                        </ul>
                    </div>
                    <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Saya berminat Paket Kaki-Kaki Komplit') }}" target="_blank" rel="noopener"
                       class="w-full border-2 border-primary text-primary py-3.5 rounded-xl font-bold text-center block hover:bg-primary hover:text-white transition-colors">Pilih Paket</a>
                </div>
            </div>
        </div>
