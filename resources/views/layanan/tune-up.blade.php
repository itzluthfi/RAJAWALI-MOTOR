...
<head>
    ...
    <title>Layanan Tune Up Presisi | Rajawali Motor Surabaya</title>
    <meta name="description" content="Servis tune up presisi, pembersihan karburator/throttle body, carbon clean, dan kalibrasi pembakaran di Rajawali Motor Surabaya.">

    <!-- OpenGraph Social Preview Meta Tags -->
    <meta property="og:type" content="website"/>
    <meta property="og:url" content="https://rajawalimotor.com/layanan/tune-up"/>
    <meta property="og:title" content="Layanan Tune Up Presisi | Rajawali Motor Surabaya"/>
    <meta property="og:description" content="Servis tune up presisi, carbon clean, pembersihan throttle body & kalibrasi pembakaran di Surabaya."/>
...
<a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Halo Rajawali Motor, saya ingin booking tune up...') }}" target="_blank" rel="noopener" aria-label="Chat via WhatsApp"
...
<nav class="fixed top-0 w-full z-50 glass-nav shadow-sm border-b border-outline-variant/20">
    <div class="flex justify-between items-center px-4 sm:px-8 py-3.5 max-w-7xl mx-auto">
        ...
        <div class="hidden lg:flex items-center gap-8 font-medium text-sm text-secondary">
            ...
            <a class="text-primary font-bold border-b-2 border-primary pb-0.5" href="{{ route('layanan.tune-up') }}">Tune Up</a>
        ...
        <div class="hidden sm:flex items-center gap-3">
            <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Halo Rajawali Motor, saya ingin booking tune up...') }}" target="_blank" rel="noopener"
...
<nav class="fixed inset-y-0 left-0 w-80 max-w-[85vw] rounded-r-2xl bg-surface z-[70] flex flex-col h-full p-6 -translate-x-full transition-transform duration-300 shadow-2xl overflow-y-auto" id="drawer">
    ...
    <div class="flex flex-col gap-2">
        ...
        <a class="flex items-center gap-3.5 p-3.5 bg-primary-container text-white font-semibold rounded-xl shadow-md" href="{{ route('layanan.tune-up') }}">
            <span class="material-symbols-outlined text-white">settings</span> Layanan Tune Up
        </a>
    ...
    <div class="mt-auto pt-6 border-t border-outline-variant/30 flex flex-col gap-3">
        <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Halo Rajawali Motor, saya ingin booking tune up...') }}" target="_blank" rel="noopener" class="efek-kilau w-full bg-[#25D366] text-white text-center py-3.5 rounded-xl font-bold text-sm shadow-lg flex items-center justify-center gap-2 hover:bg-[#20bd5a] transition-all">
...
<main class="pt-20">
    <section class="relative min-h-[70vh] flex items-center overflow-hidden">
        <div class="absolute inset-0 z-0">
            <div class="w-full h-full bg-cover bg-center" style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuAwZRhUVOA8dh9lRGumtA8A13TadrSkhT6gRIJx9nmjblYPdRE7-slJBrlnxmwPRH3EXfz16K-S7VAgHolox7HWgOVU0BZNgmikfrabup5gdrhnY2zEbxE-winTilsKQPjmfXS2o1jLxwgflWa30j8-c7QcsLIy1zY_TUEyUyG_Y-mK95fHMwQ4i5CXez0eEHaW9_xPWmB5C1Ymt0jX5bL1ZXQ1WyD5ZlHxGdDdl0h5QKKhTaHEPUYiQq_RcPOXM2x1bpAvX9_Flkg')"></div>
        ...
        <div class="relative z-10 px-4 sm:px-8 max-w-7xl mx-auto w-full py-16 sm:py-24 text-white">
            <div class="max-w-3xl space-y-6" data-reveal>
                <span class="inline-flex items-center gap-2 bg-primary-container px-4 py-1.5 rounded-full font-bold text-xs uppercase tracking-widest text-white">
                    <span class="material-symbols-outlined text-sm">settings</span> High Performance Tune Up
                </span>
                <h1 class="text-3xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">Servis Tune Up Presisi & Carbon Clean</h1>
                <p class="text-white/80 text-base sm:text-xl max-w-2xl leading-relaxed">Pengaturan presisi karburator, throttle body, busi, dan pembersihan kerak karbon ruang bakar untuk mengembalikan tenaga mesin secara maksimal.</p>
    ...
    <section class="py-20 px-4 sm:px-8 bg-surface-container-low">
        <div class="max-w-7xl mx-auto">
            <div class="text-center max-w-2xl mx-auto mb-16" data-reveal>
                <p class="text-primary font-bold text-xs uppercase tracking-widest mb-2">PAKET HARGA TUNE UP</p>
                <h2 class="font-bold text-2xl sm:text-4xl text-on-surface">Pilih Paket Tune Up Sesuai Kebutuhan</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch" data-reveal-stagger>
                <div data-reveal-item class="kartu-angkat efek-kilau bg-white p-8 rounded-3xl border border-outline-variant/40 shadow-sm flex flex-col justify-between">
                    <div>
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <h3 class="font-bold text-2xl text-on-surface">Tune Up Light</h3>
                                <p class="text-secondary text-xs mt-1">Pembersihan Standar</p>
                            </div>
                            <div class="text-right">
                                <p class="text-primary font-bold text-2xl">Rp 120.000</p>
                            </div>
                        </div>
                        <ul class="space-y-3 mb-8 text-sm text-secondary">
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Pembersihan Throttle Body / Skep</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Pembersihan Filter Udara & Busi</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Penyetelan Langsam & Rpm Idle</li>
                        </ul>
                    </div>
                    <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Saya ingin pesan Paket Tune Up Light') }}" target="_blank" rel="noopener"
                ...
                <div data-reveal-item class="kartu-angkat efek-kilau bg-inverse-surface p-8 rounded-3xl ring-4 ring-primary shadow-2xl relative flex flex-col justify-between">
                    ...
                    <div>
                        <div class="flex justify-between items-start mb-6 pt-2">
                            <div>
                                <h3 class="font-bold text-2xl text-white">Full Carbon Clean</h3>
                                <p class="text-primary-fixed-dim text-xs mt-1">Pembersihan Kerak Bakar</p>
                            </div>
                            <div class="text-right">
                                <p class="text-primary-fixed-dim font-bold text-2xl">Rp 250.000</p>
                            </div>
                        </div>
                        <ul class="space-y-3 mb-8 text-sm text-white/90">
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary-fixed-dim text-base">verified</span> Carbon Clean Liquid Chamber Treatment</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary-fixed-dim text-base">verified</span> Cleaning Throttle Body & Intake Manifold</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary-fixed-dim text-base">verified</span> Cek Pengapian & Penggantian Busi</li>
                        </ul>
                    </div>
                    <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Saya ingin pesan Paket Tune Up Full Carbon Clean') }}" target="_blank" rel="noopener"
                ...
                <div data-reveal-item class="kartu-angkat efek-kilau bg-white p-8 rounded-3xl border border-outline-variant/40 shadow-sm flex flex-col justify-between">
                    <div>
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <h3 class="font-bold text-2xl text-on-surface">Performance Ultimate</h3>
                                <p class="text-secondary text-xs mt-1">Tune Up Complete Overhaul</p>
                            </div>
                            <div class="text-right">
                                <p class="text-primary font-bold text-2xl">Rp 390.000</p>
                            </div>
                        </div>
                        <ul class="space-y-3 mb-8 text-sm text-secondary">
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Fitur Carbon Clean Complete</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Pembersihan Injektor & Tangki bensin</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Scan ECU & Kalibrasi Sensor</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Garansi Performa 14 Hari</li>
                        </ul>
                    </div>
                    <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Saya ingin pesan Paket Tune Up Performance Ultimate') }}" target="_blank" rel="noopener"
                       class="w-full border-2 border-primary text-primary py-3.5 rounded-xl font-bold text-center block hover:bg-primary hover:text-white transition-colors">Pilih Paket</a>
                </div>
            </div>
        </div>
