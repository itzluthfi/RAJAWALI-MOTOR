...
<head>
    ...
    <title>Body Repair & Cat Premium | Rajawali Motor Surabaya</title>
    <meta name="description" content="Layanan restorasi bodi mobil, perataan penyok PDR, pengecatan oven spray booth, garansi kilap cat polyurethane, dan auto detailing di Rajawali Motor Surabaya.">

    <!-- OpenGraph Social Preview Meta Tags -->
    <meta property="og:type" content="website"/>
    <meta property="og:url" content="https://rajawalimotor.com/layanan/body-repair"/>
    <meta property="og:title" content="Body Repair & Cat Premium | Rajawali Motor Surabaya"/>
    <meta property="og:description" content="Restorasi bodi mobil, pengecatan oven spray booth, garansi cat polyurethane & auto detailing di Surabaya."/>
...
<a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Halo Rajawali Motor, saya ingin booking body repair...') }}" target="_blank" rel="noopener" aria-label="Chat via WhatsApp"
...
<nav class="fixed top-0 w-full z-50 glass-nav shadow-sm border-b border-outline-variant/20">
    <div class="flex justify-between items-center px-4 sm:px-8 py-3.5 max-w-7xl mx-auto">
        ...
        <div class="hidden lg:flex items-center gap-8 font-medium text-sm text-secondary">
            ...
            <a class="hover:text-primary transition-colors" href="{{ route('layanan.ganti-oli') }}">Ganti Oli</a>
            ...
            <a class="text-primary font-bold border-b-2 border-primary pb-0.5" href="{{ route('layanan.body-repair') }}">Body Repair</a>
        </div>
        <div class="hidden sm:flex items-center gap-3">
            <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Halo Rajawali Motor, saya ingin booking body repair...') }}" target="_blank" rel="noopener"
               class="efek-kilau bg-[#25D366] text-white px-5 py-2.5 rounded-xl font-bold text-sm hover:bg-[#20bd5a] transition-all active:scale-95 shadow-md shadow-emerald-500/20 inline-flex items-center gap-2">
                ...
                <span>Booking Body Repair</span>
            </a>
        </div>
        <button class="lg:hidden text-primary p-2 rounded-xl bg-surface-container" onclick="toggleDrawer()">
...
<nav class="fixed inset-y-0 left-0 w-80 max-w-[85vw] rounded-r-2xl bg-surface z-[70] flex flex-col h-full p-6 -translate-x-full transition-transform duration-300 shadow-2xl overflow-y-auto" id="drawer">
    ...
    <div class="flex flex-col gap-2">
        ...
        <a class="flex items-center gap-3.5 p-3.5 bg-primary-container text-white font-semibold rounded-xl shadow-md" href="{{ route('layanan.body-repair') }}">
            <span class="material-symbols-outlined text-white">car_repair</span> Body Repair & Cat
        </a>
    </div>

    <div class="mt-auto pt-6 border-t border-outline-variant/30 flex flex-col gap-3">
        <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Halo Rajawali Motor, saya ingin booking body repair...') }}" target="_blank" rel="noopener" class="efek-kilau w-full bg-[#25D366] text-white text-center py-3.5 rounded-xl font-bold text-sm shadow-lg flex items-center justify-center gap-2 hover:bg-[#20bd5a] transition-all">
...
<main class="pt-20">
    <section class="relative min-h-[70vh] flex items-center overflow-hidden">
        <div class="absolute inset-0 z-0">
            <div class="w-full h-full bg-cover bg-center" style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuD-Y3EeVGPzdEfZbvAQO5X_TC5QiZxVTAGuDbXClj5lvjoya-eCaCvh6P4xNWuoGVNNWFBuggFL4pR3o7pDvjg6JcBvmPo0OEVCjNQjo0yGQsVwpe4SX1UmmmXlpqy3meCXQR7qbF4z6a7VlVaSjblz20fyRR9xCh9H6Pkyp-DuSWAh3FMpH1l0cxBAjoki29e22Ah37aV4iI6lRhCGDrKDltv2RL0X4a55-IK3YQ3MaHX-JMyWooWReo9SBaSUrfJY5hrl9VSw9Kw')"></div>
        ...
        <div class="relative z-10 px-4 sm:px-8 max-w-7xl mx-auto w-full py-16 sm:py-24 text-white">
            <div class="max-w-3xl space-y-6" data-reveal>
                <span class="inline-flex items-center gap-2 bg-primary-container px-4 py-1.5 rounded-full font-bold text-xs uppercase tracking-widest text-white">
                    <span class="material-symbols-outlined text-sm">car_repair</span> Restorasi Bodi & Pengecatan Oven
                </span>
                <h1 class="text-3xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">Restorasi Sempurna & Kilap Memukau</h1>
                <p class="text-white/80 text-base sm:text-xl max-w-2xl leading-relaxed">Kembalikan estetika kendaraan Anda dengan teknik pengecatan presisi, oven spray booth steril, dan perataan bodi tanpa cela.</p>
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
                    <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Halo Rajawali Motor, saya ingin konsultasi foto body repair...') }}" target="_blank" rel="noopener"
    ...
    <section class="py-20 px-4 sm:px-8 bg-surface">
        <div class="max-w-7xl mx-auto">
            <div class="text-center max-w-2xl mx-auto mb-16" data-reveal>
                <p class="text-primary font-bold text-xs uppercase tracking-widest mb-2">KEUNGGULAN BODY REPAIR</p>
                <h2 class="font-bold text-2xl sm:text-4xl text-on-surface">Mengapa Pilih Body Repair Rajawali?</h2>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" data-reveal-stagger>
                <div data-reveal-item class="kartu-angkat efek-kilau bg-white p-8 rounded-2xl border border-outline-variant/30">
                    <span class="material-symbols-outlined text-primary text-4xl mb-4">cleaning_services</span>
                    <h3 class="font-bold text-xl mb-2 text-on-surface">Oven Spray Booth</h3>
                    <p class="text-secondary text-sm">Ruang oven steril bebas debu untuk hasil cat mulus tanpa bintik udara.</p>
                </div>
                <div data-reveal-item class="kartu-angkat efek-kilau bg-white p-8 rounded-2xl border border-outline-variant/30">
                    <span class="material-symbols-outlined text-primary text-4xl mb-4">handyman</span>
                    <h3 class="font-bold text-xl mb-2 text-on-surface">PDR & Straightening</h3>
                    <p class="text-secondary text-sm">Teknik perataan penyok tanpa merusak struktur bodi asli jika memungkinkan.</p>
                </div>
                <div data-reveal-item class="kartu-angkat efek-kilau bg-white p-8 rounded-2xl border border-outline-variant/30">
                    <span class="material-symbols-outlined text-primary text-4xl mb-4">format_paint</span>
                    <h3 class="font-bold text-xl mb-2 text-on-surface">Cat Polyurethane High Gloss</h3>
                    <p class="text-secondary text-sm">Cat PU grade premium tahan sinar UV, anti pudar, dan tahan cuaca ekstrim.</p>
                </div>
                <div data-reveal-item class="kartu-angkat efek-kilau bg-white p-8 rounded-2xl border border-outline-variant/30">
                    <span class="material-symbols-outlined text-primary text-4xl mb-4">verified</span>
                    <h3 class="font-bold text-xl mb-2 text-on-surface">Garansi Match Warna</h3>
                    <p class="text-secondary text-sm">Komputerisasi pencocokan warna 100% presisi sesuai kode warna bawaan pabrik.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 px-4 sm:px-8 bg-surface-container-low">
        <div class="max-w-7xl mx-auto">
            <div class="text-center max-w-2xl mx-auto mb-16" data-reveal>
                <p class="text-primary font-bold text-xs uppercase tracking-widest mb-2">PAKET REPAIR & PENGECATAN</p>
                <h2 class="font-bold text-2xl sm:text-4xl text-on-surface">Pilihan Layanan Body Repair</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch" data-reveal-stagger>
                <div data-reveal-item class="kartu-angkat efek-kilau bg-white p-8 rounded-3xl border border-outline-variant/40 shadow-sm flex flex-col justify-between">
                    <div>
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <h3 class="font-bold text-2xl text-on-surface">Per Panel</h3>
                                <p class="text-secondary text-xs mt-1">Perbaikan Baret & Penyok Ringan</p>
                            </div>
                            <div class="text-right">
                                <p class="text-primary font-bold text-2xl">Mulai Rp 500rb+</p>
                            </div>
                        </div>
                        <ul class="space-y-3 mb-8 text-sm text-secondary">
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Perbaikan Bodi Per Panel (Bumper/Pintu/Kap)</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Pengecatan Oven Polyurethane</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Polishing & Finisihing Gloss</li>
                        </ul>
                    </div>
                    <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Saya ingin konsultasi Body Repair Per Panel') }}" target="_blank" rel="noopener"
                       class="w-full border-2 border-primary text-primary py-3.5 rounded-xl font-bold text-center block hover:bg-primary hover:text-white transition-colors">Konsultasi Panel</a>
                </div>
                ...
                <div data-reveal-item class="kartu-angkat efek-kilau bg-inverse-surface p-8 rounded-3xl ring-4 ring-primary shadow-2xl relative flex flex-col justify-between">
                    ...
                    <div>
                        <div class="flex justify-between items-start mb-6 pt-2">
                            <div>
                                <h3 class="font-bold text-2xl text-white">Full Body Repaint</h3>
                                <p class="text-primary-fixed-dim text-xs mt-1">Restorasi Total Bodi</p>
                            </div>
                            <div class="text-right">
                                <p class="text-primary-fixed-dim font-bold text-2xl">Hubungi Staf</p>
                            </div>
                        </div>
                        <ul class="space-y-3 mb-8 text-sm text-white/90">
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary-fixed-dim text-base">verified</span> Kerok Total & Epoxy Anti Karat</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary-fixed-dim text-base">verified</span> Pengecatan Full Oven Spray Booth</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary-fixed-dim text-base">verified</span> Vernis Clear Coat Premium Deep Gloss</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary-fixed-dim text-base">verified</span> Garansi Cat 1 Tahun</li>
                        </ul>
                    </div>
                    <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Saya berminat Konsultasi Full Body Repaint') }}" target="_blank" rel="noopener"
                       class="w-full bg-primary text-white py-3.5 rounded-xl font-bold text-center block shadow-lg hover:bg-[#930011] transition-colors">Ambil Promo Restorasi</a>
                </div>
                ...
                <div data-reveal-item class="kartu-angkat efek-kilau bg-white p-8 rounded-3xl border border-outline-variant/40 shadow-sm flex flex-col justify-between">
                    <div>
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <h3 class="font-bold text-2xl text-on-surface">Auto Detailing</h3>
                                <p class="text-secondary text-xs mt-1">Nano Ceramic Coating</p>
                            </div>
                            <div class="text-right">
                                <p class="text-primary font-bold text-2xl">Mulai Rp 1,5jt+</p>
                            </div>
                        </div>
                        <ul class="space-y-3 mb-8 text-sm text-secondary">
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> 3-Stage Paint Correction & Polish</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Multi-Layer Nano Ceramic Coating</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Hydrophobic Water-Repellent Effect</li>
                            <li class="flex items-center gap-2"><span class="material-symbols-outlined text-primary text-base">check</span> Pembersihan Detail Kabin Interior</li>
                        </ul>
                    </div>
                    <a href="https://wa.me/{{ $toko['whatsapp'] }}?text={{ urlencode('Saya berminat Paket Auto Detailing Nano Ceramic') }}" target="_blank" rel="noopener"
                       class="w-full border-2 border-primary text-primary py-3.5 rounded-xl font-bold text-center block hover:bg-primary hover:text-white transition-colors">Pilih Paket Coating</a>
                </div>
            </div>
        </div>
    </section>
